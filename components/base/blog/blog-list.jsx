...
export default function BlogList({ posts }) {
  ...
  return (
    <li className=" flex flex-col p-3 md:p-5 sm:hover:bg-gray-800 sm:rounded-md bg-gray-800 ">
      ...
      <h4 className="mb-2 lg:text-2xl text-xl py-4 font-bold line-clamp-3 text-white hover:underline">
        <Link href={`/blog/${slug}`} passHref>
          {title}
        </Link>
      </h4>
      <p className="mb-4 max-w-2xl text-neutral-400 line-clamp-3 lg:text-medium text-sm">
        {excerpt}
      </p>
