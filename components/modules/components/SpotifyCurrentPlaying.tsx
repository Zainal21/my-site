...
export default function SpotifyCurrentlyPlaying(): React.JSX.Element {
  ...
  return (
    <div className="text-center p-5 w-full flex md:flex-row flex-col items-center space-x-2 dark:bg-[#10161a]/50 bg-gray-100/50 rounded-md shadow-single border border-teal-100 dark:border-teal-900">
      {data?.albumImageUrl ? (
        <Image
          width={80}
          height={80}
