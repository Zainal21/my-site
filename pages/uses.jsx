          ...
          <Container className="mx-auto">
            <div className="py-8 lg:py-10 flex flex-col">
              ...
              <div className="pr-2 pt-3">
                <span className="font-body lg:text-lg text-md font-light text-primary dark:text-white">
                  This page lists my usual applications.
                </span>
              </div>
              <div className="pt-16 lg:pt-20">
                <h3 className="pb-8 font-body lg:text-lg text-md font-semibold text-primary dark:text-white">
                  Device
                </h3>
